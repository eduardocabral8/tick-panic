...
describe('Turn', () => {
  it('should create a turn with roundId, playerId, timeLimit and roundNumber', () => {
    const turn = new Turn('round-1', 'player-1', 5, 1);
  ...
  it('should assign a unique id', () => {
    const t1 = new Turn('round-1', 'player-1', 5, 1);
    const t2 = new Turn('round-1', 'player-2', 5, 1);
  ...
  it('should calculate score as count of valid answers', () => {
    ...
    const a2 = turn.submitAnswer('pera', new Date('2024-01-01T00:00:02Z'));
    a1.validate(true, new Date('2024-01-01T00:00:03Z'));
    a2.validate(false, new Date('2024-01-01T00:00:03Z'));
